   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "Requirement already satisfied: tensorflow in c:\\users\\acer\\anaconda3\\lib\\site-packages (2.11.0)Note: you may need to restart the kernel to use updated packages.\n",
      "\n",
  ...
  },
  {
   ...
   "outputs": [
    ...
    },
    {
     ...
     "output_type": "stream",
     "text": [
      " * Running on http://3811-2001-448a-1082-50d3-59d7-86c5-2cba-d431.ngrok.io\n",
    ...
    },
    {
     ...
     "output_type": "stream",
     "text": [
      "127.0.0.1 - - [31/Mar/2023 23:14:07] \"\u001b[37mPOST /predict HTTP/1.1\u001b[0m\" 200 -\n"
     ]
    },
    {
     "name": "stdout",
     "output_type": "stream",
     "text": [
      "{'success': True, 'label': 0, 'acc': 100.0, 'name': 'Bercak daun', 'latin': 'Phaeotrichoconis', 'all_label': [100.0, 0.0, 0.0]}\n",
      "File berhasil di simpan\n",
      "1/1 [==============================] - 0s 29ms/step\n"
     ]
    },
    {
     ...
     "output_type": "stream",
     "text": [
      "127.0.0.1 - - [31/Mar/2023 23:16:33] \"\u001b[37mPOST /predict HTTP/1.1\u001b[0m\" 200 -\n"
     ]
    },
    {
     "name": "stdout",
     "output_type": "stream",
     "text": [
      "{'success': True, 'label': 1, 'acc': 99.99939203262329, 'name': 'Kutu putih', 'latin': 'Aleyrodidae', 'all_label': [0.0, 100.0, 0.0]}\n",
      "File berhasil di simpan\n",
      "1/1 [==============================] - 0s 32ms/step\n"
     ]
    },
    {
     ...
     "output_type": "stream",
     "text": [
      "127.0.0.1 - - [31/Mar/2023 23:17:25] \"\u001b[37mPOST /predict HTTP/1.1\u001b[0m\" 200 -\n"
     ]
    },
    {
     "name": "stdout",
     "output_type": "stream",
     "text": [
      "{'success': True, 'label': 2, 'acc': 99.99996423721313, 'name': 'Ulat', 'latin': 'Lepidoptera', 'all_label': [0.0, 0.0, 100.0]}\n"
     ]
    }
   ],
   "source": [
